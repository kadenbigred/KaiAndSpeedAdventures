...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        string audioPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets", "song.wav");
        string imgPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets", "speed.png");
